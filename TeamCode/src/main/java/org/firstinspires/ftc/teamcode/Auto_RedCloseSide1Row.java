...
@Autonomous
public class Auto_RedCloseSide1Row extends LinearOpMode {
    ...
    /**************************************************
    ///MAKE SURE THAT RED CLOSE 2 ROWS AND RED 1 ROWS MATCH UP//
     ***************************************************/
    private final Pose launchPose1 = new Pose(88, 11, Math.toRadians(70));
    private final Pose launchPose2 = new Pose(87, 19, Math.toRadians(65));
    private final Pose launchPose3 = new Pose(87, 5.5, Math.toRadians(68));
    ...
    private final Pose ending = new Pose(102,44.5,Math.toRadians(0));
    ...
    scorePreload.setConstantInterpolation(startPose.getHeading()); */
        ...
        endPath = follower.pathBuilder()
                .addPath(new BezierLine(launchPose2, ending))
                .setLinearHeadingInterpolation(launchPose2.getHeading(), ending.getHeading())
                .build();
    }
